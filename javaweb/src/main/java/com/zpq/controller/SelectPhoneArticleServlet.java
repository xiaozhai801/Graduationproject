 ...
 */
@WebServlet("/SelectPhoneArticleServlet")
public class SelectPhoneArticleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectPhoneArticleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			articleList = articleDao.selectArticle(page, limit,model);
			// 设置网页格式和编码
